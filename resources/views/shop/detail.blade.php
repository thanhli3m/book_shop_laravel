                        ...
                        <div class="navbar-nav ml-auto py-0 d-none d-lg-block">
                            ...
                            <a href="{{ route('show-cart') }}" class="btn px-0 ml-3">
                                ...
                                <span class="badge text-secondary"
                                    style="padding-bottom: 2px;">Giỏ Hàng</span>
                            </a>
                        </div>
                    </div>
                </nav>
        ...
        <div class="row px-xl-5">
                ...
                <div id="product-carousel" class="carousel slide" data-ride="carousel">
                    <div class="carousel-inner bg-light">
                        <div class="carousel-item active">
                            <img class="w-100 h-100" src="{{ asset('asset/img/product-1.jpg') }}" alt="Image">
                        </div>
            ...
            <div class="col-lg-7 h-auto mb-30">
                <div class="h-100 bg-light p-30">
                    ...
                    <h6 class="font-weight-semi-bold mb-4">Số Trang: {{ number_format($book->book_page_number) }}</h6>
                    <h6 class="font-weight-semi-bold mb-4">NXB: {{ $book->publishing_company }}</h6>
                    <h6 class="font-weight-semi-bold mb-4">Xuất Bản Năm: {{ $book->publish_year }}</h6>
                    <h3 class="font-weight-semi-bold mb-4">{{ number_format($book->book_price) }} VNĐ</h3>
                    ...
                    <div class="d-flex align-items-center mb-4 pt-2">
                        <form action="{{ route('addToCart', ['id' => $book->id]) }}" method="post">
                            @csrf
                            <div class="input-group quantity mr-3" style="width: 130px;">
                                <div class="input-group-btn">
                                    <label class="btn btn-primary btn-minus">
                                        Số Lượng:
                                    </label>
                                </div>
                ...
                <div class="bg-light p-30">
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane fade" id="tab-pane-3">
                            <div class="row">
                                <div class="col-md-6">
                                    <h4 class="mb-4">{{ $count_comment }} Review for "{{ $book->book_name }}"</h4>
                                        ...
                                        <nav>
                                            <ul class="pagination justify-content-center">
                                                <li class="page-item"><a class="page-link"
                                                        href="{{ $comments->previousPageUrl() }}">Previus</a></li>
                                                <li class="page-item"><a class="page-link"
                                                        href="/?page={{ $comments->currentPage() }}">{{ $comments->currentPage() }}</a></li>
                                                <li class="page-item"><a class="page-link"
                                                        href="{{ $comments->nextPageUrl() }}">Next</a></li>
                                            </ul>
                                        </nav>
                                    </div>
                                    @endif
                                ...
                                <div class="col-md-6">
                                    ...
                                    <form action="{{ route('post-comment', ['id' => $book->id]) }}" method="POST" >
                                        @csrf
                ...
                @foreach ($suggest_products as $suggest_product)
                        <div class="product-item bg-light">
                            <div class="product-img position-relative overflow-hidden">
                                <img class="img-fluid w-100" src="{{ asset('asset/img/product-1.jpg') }}"
                                    alt="">
                                <div class="product-action">
                                    ...
                                    <a class="btn btn-outline-dark btn-square" href="{{ route('product-detail', ['id' => $suggest_product->id]) }}"><i
                                            class="fa fa-search"></i></a>
                                </div>
                            </div>
                            <div class="text-center py-4">
                                <a class="h6 text-decoration-none text-truncate" href="">{{ $suggest_product->book_name }}</a>
                                <div class="d-flex align-items-center justify-content-center mt-2">
                                    <h5>{{ number_format($suggest_product->book_price) }} VNĐ</h5>
