...
<body>
    ...
    @if (Session::has('error'))
        <p class="alert alert-success">{{ Session::get('error')->first() }}</p>
    @endif
            ...
            <div class="row px-xl-5">
                    ...
                    <table class="table table-light table-borderless table-hover text-center mb-0">
                        ...
                        <tbody class="align-middle">
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <input type="text" class="px30-input" name="user_city"
                                        value="{{ auth()->user()->user_city }}" placeholder="Thành Phố">
                                    <input type="text" class="px30-input" name="user_district"
                                        value="{{ auth()->user()->user_district }}" placeholder="Huyện">
                                    <input type="text" class="px30-input" name="user_commune"
                                        value="{{ auth()->user()->user_commune }}" placeholder="Xã">
                                    <input type="text" class="px30-input" name="user_village"
                                        value="{{ auth()->user()->user_village }}" placeholder="Làng">
                                    <input type="hidden" name="has_address" value="yes">
                                </td>
                                {{-- <td class="align-middle">
                                        <a
                                            href="{{ route('removeFromCart', ['id' => $product->id]) }}"><button
                ...
                <div class="col-lg-4">
                    ...
                    <h5 class="section-title position-relative text-uppercase mb-3"><span
                            class="bg-secondary pr-3">Action</span></h5>
                    <div class="bg-light p-30 mb-5">
                        ...
                        <button class="btn btn-block btn-primary font-weight-bold my-3 py-3">Cập Nhật Thông
                            Tin</button>
                    </div>
                </div>
            </div>
