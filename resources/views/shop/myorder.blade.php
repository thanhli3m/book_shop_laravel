                ...
                <tbody class="align-middle">
                    @foreach ($infoOrder as $order)
                        <tr>
                            ...
                            <td class="align-middle">{{ $order->book_name }}</td>

                            <td class="align-middle">{{ $order->publishing_company }}</td>

                            <td class="align-middle">{{ number_format($order->book_price) }} VND</td>

                            <td class="align-middle">
                                <a href=""><button class="btn btn-sm btn-success">Xác nhận đặt hàng</button></a>
